...
namespace DG.Tweening
{
    ...
    public static class DOTweenCYInstruction
    {
        public class WaitForCompletion : CustomYieldInstruction
        {
            ...
            public override bool keepWaiting { get { return t.active && !t.IsComplete(); } }
        ...
        public class WaitForRewind : CustomYieldInstruction
        {
            ...
            public override bool keepWaiting { get { return t.active && (!t.playedOnce || t.position * (t.CompletedLoops() + 1) > 0); } }
        ...
        public class WaitForKill : CustomYieldInstruction
        {
            ...
            public override bool keepWaiting { get { return t.active; } }
        ...
        public class WaitForElapsedLoops : CustomYieldInstruction
        {
            ...
            public override bool keepWaiting { get { return t.active && t.CompletedLoops() < elapsedLoops; } }
        ...
        public class WaitForPosition : CustomYieldInstruction
        {
            ...
            public override bool keepWaiting { get { return t.active && t.position * (t.CompletedLoops() + 1) < position; } }
        ...
        public class WaitForStart : CustomYieldInstruction
        {
            ...
            public override bool keepWaiting { get { return t.active && !t.playedOnce; } }
